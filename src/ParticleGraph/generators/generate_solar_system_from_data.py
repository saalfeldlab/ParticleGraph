...
if __name__ == '__main__':
    ...
    # read txt file
    # remove header lines
    # read 9 columns of text starting at line 55

    object_list = ['sun','mercury', 'venus', 'earth', 'mars', 'jupiter', 'saturn', 'uranus', 'neptune','io','europa','ganymede','callisto','mimas',
                   'enceladus', 'tethys','dione','rhea','titan','hyperion', 'moon', 'phobos', 'deimos','charon', 'pluto']

    object_list = ['sun','earth', 'moon']
    ...
    for object in object_list:
        ...
        filename=os.path.join('graphs_data/solar_system', f'{object}.txt')
        data = pd.read_csv(filename, header=None, skiprows=55, sep='\s+', nrows=N_Step)
