...
class CElegans_Laplacian(nn.Module):
    ...
    def forward(self, x, data_id, frame):
        ...
        pred = alpha * laplacian_u.squeeze()
    ...
    for epoch in range(200000):
        ...
        if epoch%1000 == 0:
            ...
            torch.save({'model_state_dict': model.state_dict(), 'optimizer_state_dict': optimizer.state_dict()},
                       f"/groups/saalfeld/home/allierc/signaling//Celegans/7/models/model_{epoch}.pt")
            ...
            plt.savefig(f"/groups/saalfeld/home/allierc/signaling//Celegans/7/tmp_training/scatter/output_{epoch}.png", dpi=100)
            plt.close()
            ...
            # plt.tight_layout()
            # plt.savefig(f"/groups/saalfeld/home/allierc/signaling//Celegans/7/tmp_training/function/output_u_{epoch}.png", dpi=100)
            # plt.close()

            # fig = plt.figure(figsize=(8, 8))
            # plt.plot(to_numpy(model.alpha),'.',c='k', markersize=10)
            # plt.tight_layout()
            # plt.savefig(f"/groups/saalfeld/home/allierc/signaling//Celegans/7/tmp_training/embedding/alpha_{epoch}.png", dpi=100)
            # plt.close()
            ...
            # plt.tight_layout()
            # plt.savefig(f"/groups/saalfeld/home/allierc/signaling//Celegans/7/tmp_training/embedding/embedding_{epoch}.png", dpi=100)
            # plt.close()
