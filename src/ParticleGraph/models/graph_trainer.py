...
def data_test(config=None, config_file=None, visualize=False, style='color frame', verbose=True, best_model=20, step=15, ratio=1, run=1, test_mode='', sample_embedding=False, particle_of_interest=1, device=[]):
    ...
    if 'Gcamp' in config.graph_model.field_type:
        data_test_cell_activity(config, config_file, visualize, style, True, best_model, step, ratio, 0, test_mode, device)
    else:
...
def data_test_cell_activity(config=None, config_file=None, visualize=False, style='color frame', verbose=True, best_model=20, step=15, ratio=1, run=1, test_mode='', device=[]):
