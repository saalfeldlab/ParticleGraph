...
Hexagonal spots and stripe/labyrinth patterns with tight particle clusters

[![](graphs_data/diffusiophoresis/diffusiophoresis_Claude/montage_iter_012.png){.lightbox}](brusselator.qmd)

### [Gray-Scott](grayscott.qmd)
Radial patterns only — no hexagonal symmetry breaking

[![](graphs_data/diffusiophoresis/diffusiophoresis_Claude/montage_iter_014.png){.lightbox}](grayscott.qmd)

### [FitzHugh-Nagumo](fhn.qmd)
Hexagonal and square/grid patterns with network particle structure

[![](graphs_data/diffusiophoresis/diffusiophoresis_Claude/montage_iter_018.png){.lightbox}](fhn.qmd)

### [Schnakenberg](schnakenberg.qmd)
Radial patterns with genuine steady state convergence

[![](graphs_data/diffusiophoresis/diffusiophoresis_Claude/montage_iter_041.png){.lightbox}](schnakenberg.qmd)
