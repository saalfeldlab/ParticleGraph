...
if __name__ == "__main__":
    ...
    edges = torch.load(f'graphs_data/graphs_2_particles_{datum}/edge_index_0_0.pt')
    ...
    graph_files = glob.glob(f"graphs_data/graphs_2_particles_{datum}/edge_index*")
    ...
    for run in tqdm(arr):
        ...
        for k in kr:
            x=torch.load(f'graphs_data/graphs_2_particles_{datum}/x_{run}_{k}.pt')
            y=torch.load(f'graphs_data/graphs_2_particles_{datum}/y_{run}_{k}.pt')
            if (run == 0) & (k == 0):
                xx = x
                yy = y
            else:
    ...
    for epoch in range(100):
        ...
        for N in range(1,NGraphs*niter):
            ...
            x=torch.load(f'graphs_data/graphs_2_particles_{datum}/x_{run}_{k}.pt')
            edges=torch.load(f'graphs_data/graphs_2_particles_{datum}/edge_index_{run}_{k}.pt')
            y=torch.load(f'graphs_data/graphs_2_particles_{datum}/y_{run}_{k}.pt')
