...
def load_shrofflab_celegans(file_path):
    ...
    # Load the data from the CSV file and drop rows with missing time values
    ...
    if n_normal_data != n_cells:
        ...
        print(f"Warning: incomplete time series data will be replaced by NaN: {abnormal_cells}")
