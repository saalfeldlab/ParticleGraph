...
if __name__ == '__main__':
    ...
    if args.option!=None:
        ...
        config_list = ['arbitrary_3_1','arbitrary_3_2','arbitrary_3_3','arbitrary_3_4','arbitrary_3_5','arbitrary_3_6','arbitrary_3_7']
    ...
    for config_file_ in config_list:
        ...
        if 'generate' in task:
            data_generate(config, device=device, visualize=True, run_vizualized=1, style='black color', alpha=1, erase=False, bSave=True, step=5)  #config.simulation.n_frames // 100)
        if 'train' in task:
