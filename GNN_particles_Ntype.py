...
if __name__ == '__main__':
    ...
    # config_list = ['boids_16_256_division']
    ...
    for config_file in config_list:
        ...
        data_generate(config, device=device, visualize=True, run_vizualized=0, style='frame color', erase=True, bSave=True, step=100) #config.simulation.n_frames // 1)
