...
if __name__ == '__main__':
    ...
    # config_list = ['config_gravity_4','config_Coulomb_3','config_gravity_8', 'Config_Coulomb_4']
    config_list = ['config_arbitrary_8_S','config_arbitrary_3_S','config_arbitrary_3_L']
