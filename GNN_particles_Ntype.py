...
if __name__ == '__main__':
    ...
    for config_file in config_list:
        ...
        if 'generate' in task:
            data_generate(config, device=device, visualize=True, run_vizualized=0, style='black field', alpha=1, erase=False, bSave=False, step=4)  #config.simulation.n_frames // 100)
        if 'train' in task:
