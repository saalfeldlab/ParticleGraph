...
if __name__ == '__main__':
    ...
    if args.option!=None:
        ...
        # config_list = ['fly_N9_18_1', 'fly_N9_18_2', 'fly_N9_18_3']
    ...
    for config_file_ in config_list:
        ...
        if 'generate' in task:
            data_generate(config, device=device, visualize=False, run_vizualized=0, style='black color', alpha=1, erase=False, bSave=True, step=1)  #config.simulation.n_frames // 100)
        if 'train' in task:
