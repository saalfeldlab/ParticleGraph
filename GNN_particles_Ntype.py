...
if __name__ == '__main__':
    ...
    # config_list = ["boids_voronoi_division_fortrain_a_area"]
    ...
    for config_file in config_list:
        ...
        # data_generate(config, device=device, visualize=True, run_vizualized=0, style='voronoi', alpha=1, erase=True, bSave=True, step=120) # config.simulation.n_frames // config.simulation.n_frames)
