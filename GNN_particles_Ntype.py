...
if __name__ == '__main__':
    ...
    if args.option!=None:
        ...
        config_list = ['cell_MDCK_7','cell_MDCK_8','cell_MDCK_9','cell_MDCK_10','cell_MDCK_11']
    ...
    for config_file in config_list:
        ...
        if 'generate' in task:
            data_generate(config, device=device, visualize=True, run_vizualized=0, style='black', alpha=1, erase=False, bSave=True, step=1)  #config.simulation.n_frames // 100)
        if 'train' in task:
