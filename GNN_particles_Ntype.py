...
def data_generate(config, visualize=True, style='color', erase=False, step=5, alpha=0.2, ratio=1, scenario='none', device=None):
    ...
    for run in range(config.training.n_runs):
        ...
        for it in trange(simulation_config.start_frame, n_frames + 1):
            ...
            if (it > 500) & (it%10==0) & has_cell_division & (n_particles < 20000):
...
if __name__ == '__main__':
    ...
    config_list = ['boids_16_division']  #['boids_16_division_a','boids_16_division_b','boids_16_division_c','boids_16_division_d','boids_16_division_e','boids_16_division_f']
