...
if __name__ == '__main__':
    ...
    if args.option!=None:
        ...
        # config_list = ['multimaterial_8_2','multimaterial_8_3', 'multimaterial_8'] #, 'multimaterial_2', 'multimaterial_1', 'multimaterial_3', 'multimaterial_4']
    ...
    for config_file_ in config_list:
        ...
        if 'test' in task:
            data_test(config=config, visualize=True, style='black color', verbose=False, best_model='best', run=1, test_mode='bounce_all_black', sample_embedding=False, step=10, device=device) # particle_of_interest=100,
        if 'try_func' in task:
