...
if __name__ == '__main__':
    ...
    for config_file in config_list:
        ...
        # data_generate(config, device=device, visualize=True, run_vizualized=1, style='latex frame color', alpha=1, erase=True, bSave=True, step=config.simulation.n_frames // 25)
