...
if __name__ == '__main__':
    ...
    for config_file in config_list:
        ...
        # data_test(config=con1fig, config_file=config_file, visualize=True, style='color', verbose=False, best_model='1', run=0, step=25, test_simulation=True, sample_embedding=False, device=device)    # config.simulation.n_frames // 7
