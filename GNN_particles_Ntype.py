...
if __name__ == '__main__':
    ...
    for config_file in config_list:
        for seed in seed_list:
            ...
            data_generate(config, device=device, visualize=True, run_vizualized=0, style='frame color', alpha=1, erase=False, bSave=True, step=25)  # config.simulation.n_frames // 1)
