...
if __name__ == '__main__':
    ...
    for config_file in config_list:
        ...
        # data_generate(config, device=device, visualize=False, run_vizualized=0, style='color', alpha=1, erase=False, bSave=True, step=10) # config.simulation.n_frames // config.simulation.n_frames)
