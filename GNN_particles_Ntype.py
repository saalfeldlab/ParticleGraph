...
if __name__ == '__main__':
    ...
    # config_list = ['signal_N2_a_r2']
    # config_list = ['signal_N2_a_r5']
    ...
    for config_file in config_list:
        ...
        data_generate(config, device=device, visualize=True, run_vizualized=0, style='color', alpha=1, erase=True, bSave=True, step=50) # config.simulation.n_frames // config.simulation.n_frames)
