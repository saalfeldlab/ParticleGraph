...
if __name__ == '__main__':
    ...
    if args.option!=None:
        ...
        # config_list = ['multimaterial_2_1', 'multimaterial_2_2', 'multimaterial_3', 'multimaterial_4']
    ...
    for config_file_ in config_list:
        ...
        if 'test' in task:
            data_test(config=config, visualize=True, style='black color', verbose=False, best_model='best', run=17, test_mode='plot_data', sample_embedding=False, step=4, device=device) # particle_of_interest=100,
        if 'try_func' in task:
